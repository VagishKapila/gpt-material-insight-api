...
# ✅ NEW: Route for form uploads that handles files & AI analysis
...
def generate_from_form():
    try:
        ...
        if scope_file and scope_file.filename:
            ...
            scope_path = os.path.join("scope", f"scope_{project_id}{ext}")
        ...
        # Load parsed scope items (if available)
        scope_items = load_scope_for_project(project_id)
